      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl-flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left">
            ...
            <h1 className="h1 mb-6">Hello I'm <br/> <span className="text-accent">Aryamitra Pradhan</span></h1>
            ...
            <div className="felx flex-col xl:flex-row items-center gap-8">
              <Button variable="outline" size="lg" className="uppercase flex items-center gap-2">
